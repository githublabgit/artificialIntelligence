...
public final class ZipKt {
    ...
    private static final Map<Path, ZipEntry> buildIndex(List<ZipEntry> list) {
        Path path = Path.Companion.get$default(Path.Companion, DeeplinkExtKt.BACKSLASH, false, 1, (Object) null);
    ...
    public static final ZipEntry readEntry(BufferedSource bufferedSource) throws IOException {
        ...
        return new ZipEntry(Path.Companion.get$default(Path.Companion, DeeplinkExtKt.BACKSLASH, false, 1, (Object) null).resolve(readUtf8), StringsKt.endsWith$default(readUtf8, DeeplinkExtKt.BACKSLASH, false, 2, (Object) null), bufferedSource.readUtf8(readShortLe5), readIntLe2, longRef.element, longRef2.element, readShortLe2, dosDateTimeToEpochMillis, longRef3.element);
    }
